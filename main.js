...
document.getElementById('openCurtain').addEventListener('click', function() {
  ...
  document.getElementById('click_image').addEventListener('click', function() {
  ...
  const audioapplause = document.getElementById("applause");
  const audiofireworks = document.getElementById("fireworks");
const button = document.getElementById("click_image");
